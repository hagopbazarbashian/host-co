<header class="header-light transparent has-topbar">
    ...
    <!--             <div class="topbar-widget"><a href="#"><i class="fa fa-phone"></i>+375 55446061</a></div>-->
    <!--             <div class="topbar-widget"><a href="#"><i class="fa fa-envelope"></i>info@smartdevelop.am</a></div>-->
    <!--         </div>-->
                 ...
                 <div class="de-flex sm-pt10">
                     <div class="de-flex-col">
                         <div class="de-flex-col">
                             ...
                             <div id="logo">
                                 <a href="{{route('home')}}">
                                     <img class="logo-main" src="{{asset('asset/images/IMG_4004.PNG')}}" style="width: 143px;" alt="" >
                                     <img class="logo-mobile" src="{{asset('asset/images/IMG_4004.PNG')}}"  style="width:73px;" alt="" >
                                 </a>
                             </div>
                             @endguest   
                             @auth
                     ...
                     <div class="de-flex-col header-col-mid">
                         <ul id="mainmenu">
                             ...
                             <li><a class="menu-item" href="#" id="contactUsLink">Contact Us</a></li>
                              @guest
                             <li><a class="menu-item" href="{{route('free_trial')}}"><i class="fas fa-folder-open"></i> Show Your Files</a></li>
                             @endguest
 ...
 form button:hover {
   ...
   <!-- Popup modal -->
 <div id="contactModal" style="z-index: 999;" class="modal">
