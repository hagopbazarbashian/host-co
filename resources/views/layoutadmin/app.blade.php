        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link "
                            href="../dashboard/movie/movie-list.html">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-Shows" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/tv-shows/show-list.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/tv-shows/season.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/tv-shows/episodes.html">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/errors/coming-soon.html">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="ui" data-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-avatars.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-alerts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-badges.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-breadcrumb.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-buttons.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-buttons-group.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-offcanvas.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-color.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-cards.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-carousel.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-grid.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-images.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-list-group.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-modal.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-notifications.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-pagination.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-popovers.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-typography.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-tabs.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-tooltips.html">
                                    <i class="icon" data-bs-toggle="tooltip" title="Tooltips" data-bs-placement="right"
                                        ...
                                        <i class="fa-solid fa-magnet fa-rotate-180"></i>
                                    </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="../dashboard/ui-elements/ui-embed-video.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-table" role="button" aria-expanded="false"
                            ...
                            <i class="icon" data-bs-toggle="tooltip" title="Table" data-bs-placement="right" aria-label="Table"
                                ...
                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    ...
                                    <i class="icon" data-bs-toggle="tooltip" title="FixedTable" data-bs-placement="right"
                                        aria-label="Fixed Tabl" data-bs-original-title="Fixed Tabl">
                    ...
                    <li class="nav-item">
                        <a class="nav-link "
                            href="../dashboard/icons/font-awesome.html">
                            ...
                            <span class="item-name">FontAwesome</span>
                        </a>
                    </li>
                    <li class="nav-item mb-4">
                        <a class="nav-link "
                            href="../dashboard/access-control.html">
                            <i class="icon" data-bs-toggle="tooltip" title="Access Control" data-bs-placement="right"
                        ...
                        <div class="offcanvas-body">
                           <ul class="iq-nav-menu list-unstyled">
                              ...
                              <li class="nav-item">
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="tv-shows">
                                    <li class="nav-item"><a class="nav-link "
                ...
                <div class="card card-block card-stretch card-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            ...
                            <p class="mb-0 text-primary"><span><i class="fa fa-caret-down me-2"></i></span>35%</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-block card-stretch card-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            ...
                            <p class="mb-0 text-warning"><span><i class="fa fa-caret-up me-2"></i></span>50%</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-6 col-xl-3">
                <div class="card card-block card-stretch card-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            <h4 class=" mb-0">+1M</h4>
                            <p class="mb-0 text-info"><span><i class="fa fa-caret-up me-2"></i></span>80%</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-6 col-xl-3">
                <div class="card card-block card-stretch card-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            <h4 class=" mb-0">+2M</h4>
                            <p class="mb-0 text-success"><span><i class="fa fa-caret-up me-2"></i></span>80%</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="iq-card mb-0">
                                <div class="iq-card-body p-0">
                                    ...
                                    <div class="iq-feature-list mt-3">
                                        <h6 class="font-weight-600 mb-0">The
                                                        Last Breath</h6>
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="iq-card mb-0">
                                <div class="iq-card-body p-0">
                                    ...
                                    <div class="iq-feature-list mt-3">
                                        <h6 class="font-weight-600 mb-0">Last
                                                        Night</h6>
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="iq-card mb-0">
                                <div class="iq-card-body p-0">
                                    ...
                                    <div class="iq-feature-list mt-3">
                                        <h6 class="font-weight-600 mb-0">Jeon
                                                        Woochie</h6>
                                        <p class="mb-0 mt-2">Movie</p>
                                        <div class="d-flex align-items-center my-2 iq-ltr-direction">
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="iq-card mb-0">
                                <div class="iq-card-body p-0">
                                    ...
                                    <div class="iq-feature-list mt-3">
                                        <h6 class="font-weight-600 mb-0">Dino
                                                        Land</h6>
                                        <p class="mb-0 mt-2">T.V Show</p>
                                        <div class="d-flex align-items-center my-2 iq-ltr-direction">
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="iq-card mb-0">
                                <div class="iq-card-body p-0">
                                    ...
                                    <div class="iq-feature-list mt-3">
                                        <h6 class="font-weight-600 mb-0">Open
                                                        Dead Shot</h6>
                                        <p class="mb-0 mt-2">T.V Show</p>
                                        <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                            <p class="mb-0 me-2"><i class="fa-regular fa-eye me-1"></i>134</p>
                        ...
                        <div class="card border-0">
                            <div class="card-body bg-body p-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class=" ">
                                        <p class="mb-0 font-size-14 line-height">Existing <br>
                                            Subscriber's
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="card border-0">
                            <div class="card-body bg-body p-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class=" ">
                                        <p class="mb-0 font-size-14 line-height">Extended <br>
                                            Subscriber's
                                        </p>
                                    </div>
                                </div>
