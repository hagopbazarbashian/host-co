<aside class="sidebar sidebar-base sidebar-white sidebar-default navs-rounded-all " id="first-tour" data-toggle="main-sidebar" data-sidebar="responsive">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <!--Logo start-->
                   <img class="logo-normal" src="{{asset('admin/assets/images/IMGmylogo.png')}}" alt="#">
                   <img class="logo-normal logo-white" src="{{asset('admin/assets/images/IMGmylogo.png')}}" alt="#">
                   <img class="logo-full"  src="{{asset('admin/assets/images/IMGmylogo.png')}}" alt="#">
                   <img class="logo-full logo-full-white"  src="{{asset('admin/assets/images/IMGmylogo.png')}}" alt="#">
            <!--logo End-->        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('all_files') ? 'active' : '' }}" aria-current="page" href="{{route('all_files')}}">
                        <i class="icon" data-bs-toggle="tooltip" title="Files Download" data-bs-placement="right" aria-label="Comment" data-bs-original-title="Files Download">
                            <!-- Custom SVG for "All Files Download" -->
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21 2H7C5.89543 2 5 2.89543 5 4V20C5 21.1046 5.89543 22 7 22H17C18.1046 22 19 21.1046 19 20V8L21 6V4C21 2.89543 20.1046 2 19 2H7Z" fill="currentColor"/>
                                <path d="M7 2V4H19V2H7ZM19 8H13V4H11V8H5V20H7V8H19Z" fill="currentColor"/>
                                <path d="M13 8V4L19 8H13Z" fill="currentColor"/>
                            </svg>
                        </i>
                        <span class="item-name">All Files Download</span>
                    </a>
                </li>                
                {{-- <li class="nav-item">
                    <a class="nav-link "
