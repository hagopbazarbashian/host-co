...
<!-- Widgetchart Script -->
<script src="{{asset('admin/assets/js/charts/widgetcharts.js?v=5.2.1')}}" defer></script>
<!-- Dashboard Script -->
<script src="{{asset('admin/assets/js/charts/dashboard.js?v=5.2.1')}}" defer></script>
<!-- qompacui Script -->
<script src="{{asset('admin/assets/js/streamit.js?v=5.2.1')}}" defer></script>
<script src="{{asset('admin/assets/js/sidebar.js?v=5.2.1')}}" defer></script>  
<script src="{{asset('admin/assets/js/chart-custom.js?v=5.2.1')}}" defer></script>

<script src="{{asset('admin/assets/js/plugins/select2.js?v=5.2.1')}}" defer></script>

<script src="{{asset('admin/assets/js/plugins/flatpickr.js?v=5.2.1')}}" defer></script>