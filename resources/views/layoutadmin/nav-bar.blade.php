<nav class="nav navbar navbar-expand-xl header-hover-menu navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
       {{-- <a href="../dashboard/index.html" class="navbar-brand">
          <!--Logo start-->
          <img class="logo-normal" src="{{asset('admin/assets/MG_4004.png')}}" alt="#" />
          <img class="logo-normal logo-white" src="{{asset('admin/assets/MG_4004.png')}}" alt="#" />
          <img class="logo-full" src="{{asset('admin/assets/MG_4004.png')}}" alt="#" />
          <img class="logo-full logo-full-white" src="{{asset('admin/assets/MG_4004.png')}}" alt="#" />
          <!--logo End-->
       </a> --}}
          ...
          {{-- <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive" tabindex="-1" id="offcanvasBottom">
             <div class="offcanvas-body">
                <ul class="iq-nav-menu list-unstyled">
                   <li class="nav-item"><a class="nav-link active" href="../dashboard/index.html">Home</a></li>
                   <li class="nav-item"><a class="nav-link" href="../dashboard/movie/movie-list.html">Movie List</a></li>
                   <li class="nav-item">
                      <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#tv-shows" role="button" aria-expanded="false" aria-controls="tv-shows">
                         TV Shows
                         <i class="right-icon">
                      ...
                      <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="tv-shows">
                         <li class="nav-item"><a class="nav-link" href="../dashboard/tv-shows/show-list.html">Show List</a></li>
                         <li class="nav-item"><a class="nav-link" href="../dashboard/tv-shows/season.html">Season</a></li>
                         <li class="nav-item"><a class="nav-link" href="../dashboard/tv-shows/episodes.html">Episodes</a></li>
                      </ul>
                   </li>
                </ul>
             </div>
                         ...
                         <div class="header-title">
                            <div class="iq-search-bar device-search position-relative">
                               <form action="#" class="searchbox">
                                  <input type="text" class="text search-input form-control bg-primary-subtle w-100" placeholder="Search here..." />
                               </form>
                            </div>
                         </div>
                      </div>
